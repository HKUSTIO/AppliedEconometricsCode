...
$$
- However, $x_{lj}$ and $\epsilon_{lj}$ can be correlated due to a labor demand shock specific to the skill group and the city.
...
- _Share-view_: assume the shares $z_{lk}$ are exogenous (Goldsmith-Pinkham et al. 2020).
