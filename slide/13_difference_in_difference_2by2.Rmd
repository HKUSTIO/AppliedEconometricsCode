...
- Potential outcomes: $Y_i^\ast(0, t)$ and $Y_i^\ast(1, t)$ for $t \in \{0, 1\}$.
- Observed outcome: $Y_i = D_i \cdot Y_i^\ast(1, T_i) + (1 - D_i) \cdot Y_i^\ast(0, T_i)$.
...
- Or, the potential outcomes are assumed to depend only on this period's treatment:
  - $Y_i = Y_i^\ast(0, 0)$ for $T_i = 0$ regardless of whether $G_i = 0$ or $1$.
...
$$
\tau_{ATT} = \mathbb{E}(Y_i^\ast(1, 1) - Y_i^\ast(0, 1)| G_i = 1, T_i = 1).
$$
...
&= [\mathbb{E}(Y_i| G_i = 1, T_i = 1) - \mathbb{E}(Y_i| G_i = 1, T_i = 0)]\\
&- [\mathbb{E}(Y_i| G_i = 0, T_i = 1) - \mathbb{E}(Y_i| G_i = 0, T_i = 0)]\\
&= [\mathbb{E}(Y_i^\ast(1, 1)| G_i = 1, T_i = 1) - \mathbb{E}(Y_i^\ast(0, 0)| G_i = 1, T_i = 0)]\\
&- [\mathbb{E}(Y_i^\ast(0, 1)| G_i = 0, T_i = 1) - \mathbb{E}(Y_i^\ast(0, 0)| G_i = 0, T_i = 0)]\\
&+ [\mathbb{E}(Y_i^\ast(0, 1)|G_i = 1, T_i = 1) - \mathbb{E}(Y_i^\ast(0, 0)|G_i = 1, T_i = 0)]\\
&= \tau_{ATT}\\
&+ [\mathbb{E}(Y_i^\ast(0, 1)|G_i = 1, T_i = 1) -  \mathbb{E}(Y_i^\ast(0, 0)| G_i = 1, T_i = 0)]\\
&- [\mathbb{E}(Y_i^\ast(0, 1)| G_i = 0, T_i = 1) - \mathbb{E}(Y_i^\ast(0, 0)| G_i = 0, T_i = 0)],
\end{split}
