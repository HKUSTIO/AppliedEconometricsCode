...
- Parameter $\theta$ and $\tilde{\theta$ are said to be _observationally equivalent_ if there exist information $\theta$ and $s(\phi, \theta) \neq \emptyset$ and $s(\phi, \tilde{\theta}) \neq \emptyset$.
  - If two parameters are observationally equivalent, both can be consistent with the information to the analysis.
- The parameter $\theta$ is said to be _identified if there is no other parameter $\tilde{\theta}$ that is observationally equivalent to $\theta$.
