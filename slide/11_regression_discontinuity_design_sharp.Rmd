...
- The observed outcome is $Y_i = Z_i \cdot Y_i^\ast(1) + (1 - Z_i) \cdot Y_i^\ast(0)$.
- Assume that $\{Y_i^\ast(0), Y_i^\ast(1), X_i\}_{i = 1}^n$ is a random sample from a super population.

## Estimand

- We are interested in the _sharp RD treatment effect_:<footnote> Figure 2 of Cattaneo et al. (2020) </footnote>
$$
...
- This confidence interval has a poor finite-sample performance, because $h/b$ is not zero in the finite sample.
...
- The continuity of the score density around the cutoff.
