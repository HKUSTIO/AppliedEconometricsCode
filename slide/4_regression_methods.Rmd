...
$$
\mu_0(w) \equiv \mathbb{E}[Y_i^\ast(0)|W_i = w], \mu_1(w) \equiv \mathbb{E}[Y_i^\ast(1) | W_i = w],
$$
$$
\sigma_0^2(w) \equiv \mathbb{V}_0[Y_i^\ast(0)|W_i = w], \sigma_1^2(w) \equiv \mathbb{V}[Y_i^\ast(1)|W_i = w],
$$
$$
...
- Moreover, the random assignment implies:
$$
...
where:
$$
s_0^2 \equiv \frac{1}{N_0 - 1} \sum_{i: Z_i = 0} (Y_i - \overline{Y}_0)^2, s_1^2 \equiv \frac{1}{N_1 - 1} \sum_{i: Z_i = 1} (Y_i - \overline{Y}_1)^2.
$$
...
- Consider a test statistic such that:
$$
