...
- Kohei Kawaguchi
- Empirical IO and quantitative marketing.
...
- In the following, you can start the project by double-clicking the `ECON612-T.Rproj` file in the project folder.
  ...
  - Every path written inside the project folder should be relative to the project folder to make the project portable.

## Reporting by Rmarkdown

- Make a folder `assignment` in the project folder.
- Make a HTML Rmarkdown file from `File > R Markdown > HTML`.
- Save it to `assignment` folder as `0_introduction.Rmd`.
...
- Put the cursor in a line you want to create the R chunk and press `Ctrl + Alt + I` to insert the chunk.
- Inside the R chunk, you can write and run R code.
- The outputs are shown in the report.
