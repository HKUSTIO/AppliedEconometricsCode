...
- Group: $G_i \in \{0, 1\}$.
- Treatment: $D_{it} = G_i \cdot 1\{t \ge q\}$, that is, treated in period $q$.
...
- Wooldridge, Jeffrey M. 2025. "Two-Way Fixed Effects, the Two-Way Mundlak Regression, and Difference-in-Differences Estimators." Empirical Economics 69: 2545-2587.
