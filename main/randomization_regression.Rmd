...
Next, we generate the observed data. To do this, we first generate the treatment vector `z`. This operation corresponds to a single randomization experiment. Furthermore, we calculate the realized outcomes from the realized treatment vector and potential outcomes.


```{r}
data_realized <-
  AppliedEconometrics::generate_data_randomized(
