...
Next, we generate the observed data. To do this, we first generate the treatment vector `z`. This operation corresponds to one randomization experiment. Furthermore, we calculate the realized outcomes from the realized treatment vector and the potential outcomes. This part of the process is the same as in `randomization_fisher_pvalue.Rmd`.
