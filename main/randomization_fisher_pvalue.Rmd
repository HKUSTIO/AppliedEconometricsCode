---
title: "無作為化実験 Randomized Experiment"
subtitle: "フィッシャーのp値"
output: 
  html_document:
    css: style_do.css
...
Next, we generate the observed data. To do this, we first generate the treatment vector `z`. This operation corresponds to one randomization experiment. Furthermore, we calculate the realized outcomes from the realized treatment vector and potential outcomes. The resulting `data_realized` is the observed data.
...
```{r}
t <- 
  AppliedEconometrics::calculate_difference_in_means(
