...
```{r}
p_list_rejected_benjamini_hochberg_1 <-
  p_list_1[
...
```{r}
p_list_rejected_benjamini_hochberg_0 <-
  p_list_0[
...
fdr_benjamini_hochberg <-
  p_list_rejected_benjamini_hochberg_0 %>% length() / (
    p_list_rejected_benjamini_hochberg_1 %>% length() +
    p_list_rejected_benjamini_hochberg_0 %>% length()
  )
fdr_benjamini_hochberg
```

The FDR was `r fdr` earlier, but the FDR by the Benjamini-Hochberg method is `r fdr_benjamini_hochberg`, which is slightly lower.
